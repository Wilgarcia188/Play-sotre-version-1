...
- **Editar / anotar**: dibujá a mano alzada (lápiz o resaltador), agregá texto libre y tu firma sobre cualquier página, y guardá una copia anotada del PDF.
...
- Navigation Compose
- [`PdfBox-Android`](https://github.com/TomRoush/PdfBox-Android) para unir/separar páginas, comprimir, convertir imagen↔PDF, marca de agua y anotaciones
...
Con esto, todas las funciones planeadas inicialmente están implementadas.
